...
const NegotiationHistory = () => {
  ...
  <div className="nego-wrap">
    ...
    <div className="nego-header">
        <div className="nego-header-title">네고 이력</div>
    </div>
        ...
        <table className="nego-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td className="nego-td9">2024-01-13</td>
                </tr>
                <tr>
                    <td className="nego-td1">3</td>
                    <td className="nego-td2">상품C</td>
                    <td className="nego-td3">철수</td>
                    <td className="nego-td4">010-9999-8888</td>
                    <td className="nego-td5">150,000원</td>
                    <td className="nego-td6">140,000원</td>
                    <td className="nego-td7">승인</td>
                    <td className="nego-td8">2024-01-12</td>
                    <td className="nego-td9">2024-01-14</td>
                </tr>
            </tbody>
        </table>
    </div>
